...
const Bachata = () => {
      ...
      workshops: [
        {
          id: 'básico-1',
          name: 'Básico 1',
          objectives: 'Aprender los fundamentos de la bachata, desarrollar el paso básico y dominar el ritmo característico. Enfoque en la conexión romántica y los movimientos suaves.',
          lessonCount: 24
        },
        {
          id: 'básico-2',
          name: 'Básico 2',
          objectives: 'Perfeccionar el paso básico e introducir giros fundamentales. Desarrollar la sensualidad y aprender las primeras figuras características de la bachata.',
          lessonCount: 22
        },
        {
          id: 'básico-3',
          name: 'Básico 3',
          objectives: 'Dominar figuras intermedias y mejorar la expresión corporal. Introducir movimientos más complejos y desarrollar el estilo personal romántico.',
          lessonCount: 24
        },
        {
          id: 'básico-4',
          name: 'Básico 4',
          objectives: 'Consolidar todos los movimientos básicos con figuras avanzadas. Prepararse para el nivel intermedio con técnicas de transición elegantes y sensuales.',
          lessonCount: 21
        }
      ]
    },
      ...
      workshops: [
        {
          id: 'intermedio-1',
          name: 'Intermedio 1',
          objectives: 'Aprender figuras de nivel intermedio con mayor complejidad técnica. Enfoque en la sensualidad avanzada y la conexión profunda con la pareja.',
          lessonCount: 24
        },
        {
          id: 'intermedio-2',
          name: 'Intermedio 2',
          objectives: 'Perfeccionar técnicas intermedias y desarrollar la capacidad de improvisación romántica. Mejorar la fluidez y la expresión artística.',
          lessonCount: 19
        },
        {
          id: 'intermedio-3',
          name: 'Intermedio 3',
          objectives: 'Dominar figuras complejas y perfeccionar el liderazgo sensual. Prepararse para el nivel avanzado con técnicas sofisticadas de bachata.',
          lessonCount: 18
        }
      ]
    },
      ...
      workshops: [
        {
          id: 'avanzado-1',
          name: 'Avanzado 1',
          objectives: 'Ejecutar figuras de alta complejidad y dominar la improvisación sensual. Perfeccionar la técnica con movimientos elegantes y apasionados.',
          lessonCount: 20
        },
        {
          id: 'avanzado-2',
          name: 'Avanzado 2',
          objectives: 'Perfeccionar movimientos acrobáticos sensuales y mejorar la sincronización romántica. Desarrollar la creatividad y preparar coreografías artísticas.',
          lessonCount: 17
        },
        {
          id: 'avanzado-3',
          name: 'Avanzado 3',
          objectives: 'Dominar todas las técnicas avanzadas y perfeccionar la performance romántica. Prepararse para competencias y desarrollar habilidades de enseñanza.',
          lessonCount: 15
        }
      ]
    },
      ...
      workshops: [
        {
          id: 'máster-1',
          name: 'Máster 1',
          objectives: 'Ejecutar técnicas de nivel profesional y dominar la enseñanza de bachata. Crear coreografías originales y perfeccionar el estilo único romántico.',
          lessonCount: 10
        },
        {
          id: 'máster-2',
        ...
        },
        {
          id: 'máster-3',
          name: 'Máster 3',
          objectives: 'Certificación como instructor y dominio total de la Bachata. Capacidad de crear programas de estudio y preparación para enseñar profesionalmente.',
          lessonCount: 8
        }
      ]
    }
  ...
  const handleWorkshopClick = (workshopId: string) => {
    navigate(`/workshop/bachata/${selectedLevel}/${workshopId}`);
  };
  ...
  return (
    <div>
      ...
      <div
        ...
        style={{ backgroundImage: `url(${bachataImage})` }}
      >
        <div className="absolute inset-0 bg-black/50 flex items-center justify-center p-4">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
              <span className="text-yellow-400">Bachata</span>
            </h1>
            <p className="text-xl text-gray-200 max-w-3xl mx-auto">
              Sumérgete en el romance dominicano con la bachata. Un baile lleno de pasión, 
              conexión y movimientos suaves que conquistan corazones en cada paso.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="py-16">
        <div className="container mx-auto px-4">
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                  ...
                                  <div>
                                    ...
                                    <p className="text-gray-600 text-sm mb-4">
                                      En esta lección de Bachata aprenderás técnicas específicas de conexión romántica, 
                                      movimientos suaves y expresión sensual. Enfócate en la pasión y la elegancia del baile.
                                    </p>
                                  </div>
          ...
          <div className="bg-white rounded-xl shadow-xl p-8 text-center">
            <h2 className="text-3xl font-bold text-black mb-4">¿Por qué elegir Bachata?</h2>
            <p className="text-gray-700 text-lg mb-6 max-w-4xl mx-auto">
              La Bachata es el baile del romance por excelencia. Originaria de República Dominicana, 
              se caracteriza por su ritmo suave, movimientos sensuales y la profunda conexión 
              entre los bailarines. Perfecta para expresar emociones y crear momentos únicos.
            </p>
            <a
              href="https://wa.me/51918831356?text=Quiero%20información%20sobre%20Bachata"
              target="_blank"
