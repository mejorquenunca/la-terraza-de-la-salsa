...
const Merengue = () => {
      ...
      workshops: [
        {
          id: 'básico-1',
          name: 'Básico 1',
          objectives: 'Aprender los fundamentos del merengue, desarrollar el paso básico y dominar el ritmo alegre y enérgico. Enfoque en la diversión y los movimientos dinámicos.',
          lessonCount: 24
        },
        {
          id: 'básico-2',
          name: 'Básico 2',
          objectives: 'Perfeccionar el paso básico e introducir giros fundamentales. Desarrollar la energía característica y aprender las primeras figuras del merengue.',
          lessonCount: 22
        },
        {
          id: 'básico-3',
          name: 'Básico 3',
          objectives: 'Dominar figuras intermedias y mejorar la expresión corporal enérgica. Introducir movimientos más complejos y desarrollar el estilo personal festivo.',
          lessonCount: 24
        },
        {
          id: 'básico-4',
          name: 'Básico 4',
          objectives: 'Consolidar todos los movimientos básicos con figuras avanzadas. Prepararse para el nivel intermedio con técnicas de transición dinámicas y alegres.',
          lessonCount: 21
        }
      ]
    },
      ...
      workshops: [
        {
          id: 'intermedio-1',
          name: 'Intermedio 1',
          objectives: 'Aprender figuras de nivel intermedio con mayor complejidad técnica. Enfoque en la energía avanzada y la diversión contagiosa del merengue.',
          lessonCount: 24
        },
        {
          id: 'intermedio-2',
          name: 'Intermedio 2',
          objectives: 'Perfeccionar técnicas intermedias y desarrollar la capacidad de improvisación festiva. Mejorar la fluidez y la expresión artística enérgica.',
          lessonCount: 19
        },
        {
          id: 'intermedio-3',
          name: 'Intermedio 3',
          objectives: 'Dominar figuras complejas y perfeccionar el liderazgo dinámico. Prepararse para el nivel avanzado con técnicas sofisticadas de merengue.',
          lessonCount: 18
        }
      ]
    },
      ...
      workshops: [
        {
          id: 'avanzado-1',
          name: 'Avanzado 1',
          objectives: 'Ejecutar figuras de alta complejidad y dominar la improvisación enérgica. Perfeccionar la técnica con movimientos elegantes y espectaculares.',
          lessonCount: 20
        },
        {
          id: 'avanzado-2',
          name: 'Avanzado 2',
          objectives: 'Perfeccionar movimientos acrobáticos dinámicos y mejorar la sincronización festiva. Desarrollar la creatividad y preparar coreografías espectaculares.',
          lessonCount: 17
        },
        {
          id: 'avanzado-3',
          name: 'Avanzado 3',
          objectives: 'Dominar todas las técnicas avanzadas y perfeccionar la performance energética. Prepararse para competencias y desarrollar habilidades de enseñanza.',
          lessonCount: 15
        }
      ]
    },
      ...
      workshops: [
        {
          id: 'máster-1',
          name: 'Máster 1',
          objectives: 'Ejecutar técnicas de nivel profesional y dominar la enseñanza de merengue. Crear coreografías originales y perfeccionar el estilo único festivo.',
          lessonCount: 10
        },
        {
          id: 'máster-2',
        ...
        },
        {
          id: 'máster-3',
          name: 'Máster 3',
          objectives: 'Certificación como instructor y dominio total del Merengue. Capacidad de crear programas de estudio y preparación para enseñar profesionalmente.',
          lessonCount: 8
        }
      ]
    }
  ...
  const handleWorkshopClick = (workshopId: string) => {
    navigate(`/workshop/merengue/${selectedLevel}/${workshopId}`);
  };
  ...
  return (
    <div>
      ...
      <div
        ...
        style={{ backgroundImage: `url(${merengueImage})` }}
      >
        <div className="absolute inset-0 bg-black/50 flex items-center justify-center p-4">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
              <span className="text-yellow-400">Merengue</span>
            </h1>
            <p className="text-xl text-gray-200 max-w-3xl mx-auto">
              Vive la alegría dominicana con el merengue. Un baile lleno de energía, 
              diversión y ritmo contagioso que te hará mover todo el cuerpo al compás de la música.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="py-16">
        <div className="container mx-auto px-4">
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                  ...
                                  <div>
                                    ...
                                    <p className="text-gray-600 text-sm mb-4">
                                      En esta lección de Merengue aprenderás técnicas específicas de energía, 
                                      movimientos dinámicos y expresión festiva. Enfócate en la alegría y la diversión del baile.
                                    </p>
                                  </div>
          ...
          <div className="bg-white rounded-xl shadow-xl p-8 text-center">
            <h2 className="text-3xl font-bold text-black mb-4">¿Por qué elegir Merengue?</h2>
            <p className="text-gray-700 text-lg mb-6 max-w-4xl mx-auto">
              El Merengue es pura alegría dominicana. Con su ritmo rápido y movimientos enérgicos, 
              es el baile perfecto para liberar tensiones y disfrutar al máximo. Fácil de aprender 
              pero con infinitas posibilidades de expresión y diversión.
            </p>
            <a
              href="https://wa.me/51918831356?text=Quiero%20información%20sobre%20Merengue"
              target="_blank"
